...
# Animation Names
var anim_jump = "CharacterArmature|CharacterArmature|CharacterArmature|Jump|CharacterArmature|Jump"
var anim_run = "CharacterArmature|CharacterArmature|CharacterArmature|Run|CharacterArmature|Run"
var anim_idle = "CharacterArmature|CharacterArmature|CharacterArmature|Idle|CharacterArmature|Idle"
...
func perform_flip_jump():
	...
	animation.play(anim_jump, -1, 2)
	velocity.y = jump_force
	await animation.animation_finished
	can_double_jump = false
	animation.play(anim_jump, 0.5)
...
func player_animations():
	...
	if is_on_floor():
		if is_moving():
			animation.play(anim_run, 0.5)
			particle_trail.emitting = true
			footsteps.stream_paused = false
		else:
			animation.play(anim_idle, 0.5)
